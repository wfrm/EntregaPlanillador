    ...
    // Estamos accediendo desde entorno local
    BASE_URL = "http://192.168.1.111";
  } else {
    // Estamos accediendo al ESP8266 directamente
...
for (let key in HorarioModel.periodosPreconfigurados) {
    ...
    botoneraRapida.innerHTML += `
        ...
        <button class="puesto-button" onclick="PeriodoController.handleButtonClick(this, '${key}')">
...
const SyncController = {
    ...
    apiUrlWS: `${BASE_URL}:81`, 
    ws: null,
    apiUrlLeerConfig: `${BASE_URL}/leerConfig`,
...
leerArchivoConfigRapida: function() {
    const url = `${BASE_URL}/leerArchivo?archivo=config-rapida`;
...
enviarPeriodosPreconfigurados:function () {
    ...
    fetch(`${BASE_URL}/saveconfig-rapida?${queryParams}`, {
        method: 'GET',
        /*headers: {
